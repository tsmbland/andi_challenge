...
I think changing from adam to sgd would help
- might have to have learing rate scheduler
...
#                     callbacks=[
#                         ModelCheckpoint(filepath='ModelCNN_20_100_padding.h5', monitor='mae', save_best_only=True,
...
"""
model = load_model('ModelCNN_20_100_padding.h5')

# Test data
test_tracks, test_alphas = generate_tracks(n=1000, track_length_vals=[50])
