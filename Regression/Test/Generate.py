...
tracks_1D, exponents_1D = generate_tracks_regression(n=n, dimensions=1, min_T=10, max_T=1001)
...
tracks_2D, exponents_2D = generate_tracks_regression(n=n, dimensions=2, min_T=10, max_T=1001)
